...
public class EditFolderDialog extends Dialog {
    ...
    private Logger logger = Logger.getLogger(EditFolderDialog.class);
    ...
    public EditFolderDialog(Shell parent, Controller controller, Engine engine, Folder folder) {
        super(parent, SWT.DIALOG_TRIM | SWT.APPLICATION_MODAL);
        this.controller = controller;
        setText(Labels.get("EditFolderDialog.WindowTitle"));
        this.engine = engine;
        this.folder = folder;
    }
    ...
    private void createContents(final Shell shell) {
        ...
        label.setText(Labels.get("EditFolderDialog.LabelName"));
        fd = new FormData();
        ...
        button.setText(Labels.get("EditFolderDialog.LabelPublished"));
        fd = new FormData();
        fd.top = new FormAttachment(0, 60);
        fd.left = new FormAttachment(0, 10);
        button.setLayoutData(fd);
        button.setSelection(folder.getPublished());
        ...
        button.setText(Labels.get("EditFolderDialog.ButtonClose"));
        fd = new FormData();
        ...
        button = new Button(shell, SWT.PUSH);
        button.setText(Labels.get("EditFolderDialog.ButtonSave"));
        fd = new FormData();
        fd.bottom = new FormAttachment(100, -10);
        ...
        button.addSelectionListener(new SelectionListener() {
			...
			public void widgetSelected(SelectionEvent arg) {
				...
				if (name.length() == 0) {
					UITool.warningBox(shell, Labels.get("EditFolderDialog.NameRequired"));
					return;
				}
				if (findFolderByName(name) != null) {
					UITool.warningBox(shell, Labels.get("EditFolderDialog.NameExists"));
					return;
				}
